const data = [
	...
	},
	{
		id: 8,
		name: "Munnar",
		info: "Munnar rises as three mountain streams merge  - Mudrapuzha, Nallathanni and Kundala. One of the most sought after honeymoon destinations in Kerala, Munnar is replete with resorts and logding facilities that fit a wide rage of budgets. Sprawling tea plantations, picturesque towns, winding lanes and holiday facilities make this a popular resort town. Among the exotic flora found in the forests and grasslands here is the Neelakurinji. This flower which bathes the hills in blue once in every twelve years, will bloom next in 2030. Munnar also has the highest peak in South India, Anamudi, which towers over 2,695 m. ",
		image: "https://images.unsplash.com/photo-1629813538702-64c925934e19?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80",
		price: "50,595",
	},
	{
		id: 9,
		name: "Meghalaya",
		info: "Meghalaya is one of the Seven Sister States of northeast India. The state of Meghalaya is mountainous, with stretches of valley and highland plateaus, and it is geologically rich. There are approximately 16 main waterfalls in Meghalaya. These include Nohkalikai Falls, Khoh Ramhah, Kynrem Falls, Nohsngithiang Falls, Elephant Falls, Spread Eagle Falls, Sweet Falls, Weinia Falls, Thum Falls, Krang Suri, Tyrshi Falls, Thlumuwi Falls, Pelga Falls, Imil Chang Dare, and Rong'bang Falls. Nohkalikai Falls is the tallest plunge waterfall in India. Its height is 340 metres (1,115 ft). The waterfall is located in the Indian state of Meghalaya, near Cherapunji, one of the wettest places on Earth.",
		image: "https://images.unsplash.com/photo-1625826415766-001bd75aaf52?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1935&q=80",
		price: "60,595",
	},
];
